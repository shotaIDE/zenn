...
一方で、目指すべき方向性を抽象的に伝えるだけでは、実際に行動に移すことが難しいです。
...
メンバーに何かやってもらいたいとき、やってもらう内容だけでなく、なぜそれをやってもらいたいのかという背景や意図を明確に伝えるようにすることが重要です。
こうした取り組みを行うことで、折に触れてメンバーが目指すべき方向性を意識してもらえるようになるためです。
...
一方で、目指すべき方向性を抽象的に伝えるだけでは、実際に行動に移すことが難しいという課題があります。
そのため、具体的な運用につながっていくよう、自ら手本を示したり、細かい仕組み化を行ったりしました。
