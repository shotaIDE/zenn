...
> - **より良い実装方法を考える際にデグレせずに安全に進められるようにする**
...
- PR の単位はできるだけ小さくする。これにより、レビューの効率が向上し、問題が発見しやすくなるため、品質の維持が容易になります。
