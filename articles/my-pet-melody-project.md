...
これらの画面では、最重要なユーザー体験に辿り着く確率を上げることを重要と考えた際に、タイトルバーに表示されているテキストや戻るボタンは、動画選択などのアクションボタンよりも重要度が低いです。
そのため、オリジナル曲を作るフローでユーザーが操作に迷いにくいようにすることで、最重要なユーザー体験に辿り着く可能性をあげることに寄与できると考えたためです。

# イラスト

コンセプト的に、可愛い雰囲気にしたいと考えたので、猫のイラストをデザイナーに依頼しました。
