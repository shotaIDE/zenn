...
1. 対応した PR により機能のデグレードが発生している
2. 対応した PR により機能のデグレードは発生していないものの、チケットに記載しているバグが完全には解消していない
   - PR をリリースする
3. 対応した PR により機能のデグレードは発生しておらず、チケットに記載しているバグが解消している一方で、別のバグが見つかっている
