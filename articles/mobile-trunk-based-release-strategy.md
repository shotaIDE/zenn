...
- 定期的な自動・手動リグレッションテストのコストを最小にしつつ、価値を最大化するため
   - 開発者・QAが同じブランチを触る・検証する
- トランクブランチが壊れた場合にすぐに気づきやすく、復元時間を最短にすることができる。
- フィーチャーフラグをリモートで管理することにより、切り戻しの範囲を柔軟に設定でき、所要時間を最小化できる
...
- サイレントリリースすることにより、
- プロダクトオーナー、QAなど関係者すべてに周知し、キャッチアップしてもらう必要がある
