...
メンバーの成長や、チーム設計や変更なども考慮に入れるともっと考えることが増えるはずですが、それは本記事の対象外とします。

# 環境を明確にする

プロジェクトには目指すべき方向や制約があります。

そのような環境を理解することは、プロジェクトで効率的にアクションをとるために重要です。
...
そのため、メンバーに対して向き合い、適切な役割分担やコミュニケーションをとることが重要です。
